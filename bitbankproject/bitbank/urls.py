...
urlpatterns = [
    ...
    path('ajax_get_stop_orders/', views.ajax_get_stop_orders, name="ajax_get_stop_orders"),
    path('ajax_cancel_order/', views.ajax_cancel_order, name="ajax_cancel_order"),
    path('ajax_cancel_stop_order/', views.ajax_cancel_stop_order, name="ajax_cancel_stop_order"),
    ...
    path('alert/', views.AlertCreate.as_view(), name='alert'),
    path('alert/list/', views.AlertList.as_view(), name='alert_list'),
    path('alert_detail/<int:pk>/', views.AlertDetail.as_view(), name='alert_detail'),
