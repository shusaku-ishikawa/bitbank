# Generated by Django 2.1.5 on 2019-02-22 01:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cancel_if_done', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='bitbank.BitbankOrder')),
                ('order_if_done', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='bitbank.BitbankOrder')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_1', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='new_order', to='bitbank.BitbankOrder', verbose_name='新規注文')),
                ('order_2', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='settle_order_1', to='bitbank.BitbankOrder', verbose_name='決済注文1')),
                ('order_3', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='settle_order_2', to='bitbank.BitbankOrder', verbose_name='決済注文2')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': '注文',
